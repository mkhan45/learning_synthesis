...
export function synthesize(inps, outs, tests) {
    const ptr0 = passArrayJsValueToWasm0(inps, wasm.__wbindgen_export_0);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(outs, wasm.__wbindgen_export_0);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArrayJsValueToWasm0(tests, wasm.__wbindgen_export_0);
